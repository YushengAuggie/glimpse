...
// text/quote/anchor are already secret-scrubbed at persist time (glimpse_threads.py);
...
// All thread writes funnel through the flocked Python writer via the CLI (idempotent
// by clientTurnId), exactly as the bridge does.
